...
namespace zadacha6
{
    public partial class Form1 : Form
    {
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            newAnimal.Age = int.Parse(txtbName.Text);
            newAnimal.Name = txtbID.Text;
            //записва в таблицата Id на избрания елемент =>
            //Разлиства имената на породите, а записва съответното Id
            newAnimal.BreedsId = (int)cmbbBreed.SelectedValue;
        ...
        private void btnSelectAll_Click(object sender, EventArgs e)
        {
            ...
            {
                listBox1.Items.Add($"{item.Id}. {item.Name} - Age: {item.Age} Breed:
                { item.Breed.Name}
                ");
                 }
